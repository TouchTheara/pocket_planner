            ...
            Expanded(
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          return authController.animatedController!.isAnimating
                              ? Padding(
                  ...
                  Text(
                    "Code is send to +855${authController.phoneController.value.text.replaceAll(RegExp(r'^0+(?=.)'), '')}",
                  ...
                  Form(
                    ...
                    child: Padding(
                      ...
                      child: PinCodeTextField(
                        ...
                        controller: authController.verifyOtpController.value,
                        appContext: context,
