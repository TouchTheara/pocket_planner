                  ...
                  child: Form(
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTextField(
                          controller:
                              plannerController.priorityController.value,
                          isValidate:
                              !plannerController.priorityValidator.value,
                        ...
                        CustomTextField(
                          controller: plannerController
                              .selectionDueDateController.value,
                          isValidate: !plannerController
                              .selectionDueDateValidator.value,
                          suffixIcon: const Icon(Icons.keyboard_arrow_down),
                          ...
                          child: CustomButton(
                            ...
                            ontap: () {
                              getIt<PlannerController>().functionCreatePlanner(
                                  context,
                                  title: plannerController
                                      .projectNameController.value.text,
                                  description: plannerController
                                      .descriptionController.value.text,
                                  priorityApp: plannerController
                                      .priorityController.value.text,
                                  startDateApp: plannerController
