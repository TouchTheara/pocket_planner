            ...
            child: Form(
              child: Column(
                ...
                children: [
                  ...
                  CustomTextField(
                      controller: plannerController.projectNameController.value,
                      isValidate: !plannerController.projectNameValidator.value,
                      labelText: 'Project name',
                      hintText: 'Project name',
                      onChange: (value) {
                        if (value == "") {
                          plannerController.projectNameValidator.value = true;
                        } else {
                          plannerController.projectNameValidator.value = false;
                        }
                      }),
                  const SizedBox(
                    height: 20,
                  ...
                  CustomTextField(
                      controller: plannerController.descriptionController.value,
                      isValidate: !plannerController.descriptionValidator.value,
                      labelText: 'Description',
                      hintText: 'Description',
                      onChange: (value) {
                        if (value == "") {
                          plannerController.descriptionValidator.value = true;
                        } else {
                          plannerController.descriptionValidator.value = false;
                        }
                      }),
                  const SizedBox(
                    height: 20,
                  ...
                  CustomTextField(
                    controller: plannerController.priorityController.value,
                    isValidate: !plannerController.priorityValidator.value,
                  ...
                  CustomTextField(
                    controller:
                        plannerController.selectionDueDateController.value,
                    isValidate:
                        !plannerController.selectionDueDateValidator.value,
                    suffixIcon: const Icon(Icons.keyboard_arrow_down),
